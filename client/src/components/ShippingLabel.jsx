...
const INSTITUTION_KEYWORD_RE = /(บ้านพัก|มหาวิทยาลัย|วิทยาลัย|สถาบัน|โรงเรียน|ค่ายทหาร|ค่าย|กรม|กองพล|กองร้อย|กองบิน|กอง(?!ทัพ)|สภ\.|สถานีตำรวจ|โรงพัก|ตชด\.|เรือนจำ|ทัณฑสถาน|มณฑลทหารบก|หน่วย|ป้อมตำรวจ|ฐานทัพ|ศูนย์แพทยศาสตร์)/;
// จุดเริ่มของที่อยู่
...
const ADDRESS_START_RE = /(?:มบ\.?|เดอะ|The|โครงการ|หมู่บ้าน|บ้านพัก|คอนโด(?:มิเนียม)?|เพลส|อาคาร|ตึก|บ้านเลขที่|เลขที่|หมู่ที่|หมู่\s+|\b\d{1,3}\/\d+|\b\d{1,4}\s+(?:ซอย|ถนน|หมู่|ม\.|ต\.|อ\.|จ\.))/i;
